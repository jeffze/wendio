...
const TRANSLATIONS = {
  ...
  'aide.s5.e2.p':              { fr: "Mode En ligne, Tirage Aléatoire (sauf si tu as reçu un paquet de cartes à jouer du conseil de bande), et le clan imposé que tous les joueurs devront viser.",
                                 en: 'Online mode, Random draw (unless your band council provided you with a deck of playing cards), and the imposed clan that all players will aim for.' },
  ...
  'aide.s7.demo.p1':           { fr: "Pour faire une démonstration de Wendio à quelqu'un (parent, partenaire, classe de profs) sans avoir de vrais joueurs sous la main, utilise le bouton « 🤖 Simuler 3 joueurs » qui apparaît dans la sidebar quand tu as créé une partie en ligne.",
  ...
  'aide.s7.demo.p2':           { fr: "Le serveur ajoute 3 joueurs « bots » avec des cartes aléatoires (Alice, Bob, Carla...). Tu démarres la partie, tu tires des numéros, et l'un d'eux finit par gagner naturellement (le clan Chevreuil est le plus rapide pour une démo, en ~10-15 tirages).",
                                 en: 'The server adds 3 « bot » players with random cards (Alice, Bob, Carla...). You start the game, draw numbers, and one of them eventually wins naturally (the Deer clan is the fastest for a demo, around 10-15 draws).' },
  'aide.s7.demo.astuce.titre': { fr: 'Recette démo express (5 min)',
                                 en: 'Express demo recipe (5 min)' },
  'aide.s7.demo.astuce.txt':   { fr: 'Lobby → Meneur → En ligne → Aléatoire → Chevreuil → « Créer la partie » → « 🤖 Simuler 3 joueurs » → « Commencer la partie » → tirer rapidement jusqu\'à la victoire (l\'overlay gagnant apparaît tout seul).',
                                 en: 'Lobby → Master → Online → Random → Deer → « Create game » → « 🤖 Simulate 3 players » → « Start the game » → draw quickly until victory (the winner overlay appears by itself).' },
