...
const TRANSLATIONS = {
  ...
  'aidej.s3.chevreuil':        { fr: "🦌 Chevreuil (Ohskënonton') — toutes les 32 cases numérotées. Le plus long et le plus prestigieux.",
                                 en: "🦌 Deer (Ohskënonton') — all 32 numbered cells. The longest and most prestigious." },
  'aidej.s3.tortue':           { fr: "🐢 Tortue (Yāndia'wich) — l'anneau de 12 cases qui entoure le Cœur.",
                                 en: "🐢 Turtle (Yāndia'wich) — the 12-cell ring around the Heart." },
  'aidej.s3.ours':             { fr: "🐻 Ours (Yānionyen') — les 4 coins de la carte.",
                                 en: "🐻 Bear (Yānionyen') — the 4 corners of the card." },
  'aidej.s3.loup':             { fr: "🐺 Loup (Yānariskwa') — une ligne complète (horizontale, verticale ou diagonale). Le plus rapide à gagner.",
                                 en: "🐺 Wolf (Yānariskwa') — one complete line (horizontal, vertical or diagonal). The quickest to win." },
